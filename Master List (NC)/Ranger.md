...
|Starting Equipment|Choose A or B:  <br>(A) Studded Leather Armor, Scimitar, Shortsword, Longbow, 20 Arrows, Quiver, Druidic Focus (sprig of mistletoe), Explorer's Pack and 7 GP  <br>(B) 150 GP|
# Class Features
---
## Features Chart
---
...
## Level 3
### Subclass
You gain a Barbarian subclass of your choice. [[dnd/Master List (NC)/Ranger]]
## Level 4
...
You magically summon a primal beast, which draws strength from your bond with nature. Choose its stat block: **[[dnd/Master List (NC)/Ranger]]**[[dnd/Master List (NC)/Ranger]]**[[dnd/Master List (NC)/Ranger]]**[[dnd/Master List (NC)/Ranger]]**[[dnd/Master List (NC)/Ranger]]**. You also determine the kind of animal it is, choosing a kind appropriate for the stat block. Whatever beast you choose, it bears primal markings indicating its supernatural origin.
...
> |   |   |
> |---|---|
> |Primal Bond|Add your Proficiency Bonus to any ability check of saving throw the beast makes.|
> 
> ### Actions
> 
> |   |   |
...
> |   |   |
> |---|---|
> |Beast's Strike|_Melee Attack Roll_: Bonus equals your spell attack modifier, reach 5 ft. Hit: 1d6 + 2 plus your Wisdom modifier Bludgeoning or Piercing damage (Your choice when you summon the beast), and the target has the Grappled condition (escape DC equals your spell save DC).|
## Fey Wanderer
...
|Dreadful Strike|When you hit a creature with a weapon, deal an extra 2d6 Psychic damage. Usable once per turn, a number of times equal to your Wisdom modifier per Long Rest.|
|Initiative Bonus|When you roll Initiative, add your Wisdom modifier to the roll.|
### Level 7: Iron Mind
...
|Mass Fear|Target and each creature within 10 feet must make a Wisdom saving throw against your spell save DC. On failure, they are Frightened until your next turn.|
...
|   |   |
|---|---|
|Colossus Slayer|When you hit a creature with a weapon, it deals an extra 1d8 damage if the target is missing any Hit Points. This extra damage can be applied only once per turn.|
|Horde Breaker|Once per turn, after making a weapon attack, you can make another attack with the same weapon against a different creature within 5 feet of the original target.|
### Level 7: Defensive Tactics
You gain one of the following feature options of your choice. Whenever you finish a Short or Long Rest, you can replace the chosen option with the other one.
|   |   |
|---|---|
|Escape the Horde|Opportunity Attacks against you have Disadvantage.|
|Multiattack Defense|When a creature hits you with an attack roll, that creature has Disadvantage on all subsequent attack rolls against you this turn.|
