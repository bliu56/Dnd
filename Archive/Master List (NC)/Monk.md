...
|Armor Training|None|
|Starting Equipment|Choose A or B:  <br>(A) Spear, 5 Daggers, Artisan's Tools or Musical Instrument chosen for the tool proficiency above, Explorer's Pack and 11 GP  <br>(B) 50 GP|
# Class Features
---
## Features Chart
---
...
|2|+2|Monk's Focus, Unarmored Movement, Uncanny Metabolism|
...
### Subclass
You gain a Barbarian subclass of your choice. [[dnd/Master List (NC)/Monk]]
## Level 4
