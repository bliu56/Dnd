- **Role:** Church Paladin, Unaware Hero Candidate
...
- Together — a trauma bond that became something real
- The bickering never left, it just changed texture. Less friction, more rhythm
- She grounds him. He steadies her. They don't talk about it
- His entire combat philosophy is built around her — him at the front, her at the back
...
### Relationship with [[dnd/DM Sheet/ABCD/World 1/Characters/Michael|Michael]]'s Memory
...
- Trained extensively in the Church's swordsmanship curriculum — emerged with something recognizably theirs but distinctly his
- Adjusted at the edges: footwork slightly different, angles more aggressive, economy of motion tuned to how he actually moves rather than how the form dictates
- Combat philosophy built entirely around a two-person unit: him as frontline, Luna as backline
...
- **AC:** 16 (chain mail) | **HP:** 91 (14d10 + 14) | **Speed:** 30 ft.
- **CR:** 5
...
- **Skills:** Athletics +6, Perception +4, Survival +4, Intimidation +3
...
- **Survivor's Instinct.** John has advantage on initiative rolls and cannot be surprised while conscious.
- **Unbroken.** When reduced to half HP or below, his attacks deal an additional 1d6 damage.
- **Paladin's Resolve.** John is immune to the frightened condition.
...
- **Multiattack.** John makes two Longsword attacks.
- **Longsword.** _+6 to hit, reach 5 ft._ Hit: 1d8+3 slashing (1d10+3 two-handed).
